...
Latest released version is 1.4.3 and its source code can be downloaded by clicking below link.

<a href="https://github.com/mhogomchungu/sirikali/releases/download/1.4.3/SiriKali-1.4.3.tar.xz">SiriKali-1.4.3.tar.xz</a>

## Download links for Microsoft Windows Operating System.

There are two packages for Windows Windows, the one with an installer is <a href="https://github.com/mhogomchungu/sirikali/releases/download/1.4.3/SiriKali-1.4.3.setup.exe">here</a> and the one without an installer(portable version) is <a href="https://github.com/mhogomchungu/sirikali/releases/download/1.4.3/SiriKali-1.4.3.exe.zip">here.</a>
...
last update: Wed 01 Apr 2020 09:58:57 AM EAT
